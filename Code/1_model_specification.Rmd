...
R_model$states = bind_rows(
  data.frame(
    ...
    abbr = c("M","lE","hE","preO","O","postO","Lut","Ano","AB"), # "dO",
    colors = c("red3","skyblue1","skyblue2", "blue","black","gold3","gold1","gray","salmon"), # "skyblue3",
    group = c(rep("Ovulatory",7), "Anovulatory","Anovulatory"),
...
p[c("hE","preO","O","postO","L")] = 0.3 # most people track ~2/3 days in these states # "dO",
...
q["LH",] = 0.99
q["LH",c("hE","preO","O","postO")] = 0.5 # "dO",

q["mucus",] = 0.5
q["mucus",c("hE","preO","O","postO")] = 0.4
q["mucus",c("Ano")] = 0.1 # that's how we know this is happening "dO",
