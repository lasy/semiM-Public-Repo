...
kable(
  ...
  format = "latex",
  booktabs = T, 
  caption = "Initial probabilities for each state of the HSMM of reproductive events."
) %>% 
...
round(R_model$trans, 2) %>%  
  kable(., 
        format = "latex",
        booktabs = T, 
        caption = "Transition probabilities between states of the HSMM of reproductive events.")%>% 
...
rm(bleeding_probs, high_bleeding, rare_spotting, frequent_spotting, no_bleeding)
```
...
```{r R-model-marg-em-par-viz, fig.height=8, fig.width=5, fig.cap="Marginal emission probabilities of our reproductive events HSMM."}
...
```{r R-model-simulated-seq, fig.width=12, fig.height=3, warning=FALSE}
