...
b_original = m$b %>% filter(!is.na(var1), !is.na(var2)) %>% pivot_longer(col = starts_with("p_"), names_to = "state", values_to = "prob", names_prefix = "p_")
b_fit = model_fit$model$b %>% filter(!is.na(var1), !is.na(var2))%>% pivot_longer(col = starts_with("p_"), names_to = "state", values_to = "prob", names_prefix = "p_")
