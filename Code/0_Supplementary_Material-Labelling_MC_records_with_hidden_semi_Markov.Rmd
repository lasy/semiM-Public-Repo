...
```{r child = '1_model_specification.Rmd', cache=TRUE}
```

\newpage

```{r child = '2_datasets.Rmd', cache=TRUE}
```

\newpage


```{r child = '3_decoding.Rmd', cache=TRUE}
```

\newpage


```{r child = '4_performances.Rmd', cache=TRUE}
```

\newpage

```{r child = '5_predicting_periods.Rmd', cache=TRUE}
```


\newpage

```{r child = '6_within_state_dependencies.Rmd', cache=TRUE}
```
